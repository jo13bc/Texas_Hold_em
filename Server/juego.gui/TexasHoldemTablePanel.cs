...
namespace Servidor.juego.gui
{
    ...
    private static readonly ConsoleColor DEFAULT_BORDER_PLAYER_COLOR = new Color(0xb06925);
    private static readonly ConsoleColor TEXT_ROUND_COLOR = new Color(0x004000);
    private static readonly ConsoleColor ACTIVE_PLAYER_FOREGROUND_COLOR = new Color(0x033E6b);
    private static readonly ConsoleColor ACTIVE_PLAYER_BACKGOUND_COLOR = new Color(0x66a3d2);
    private static readonly ConsoleColor PLAYER_TURN_FOREGROUND_COLOR = new Color(0X186b18);
    private static readonly ConsoleColor PLAYER_TURN_BACKGROUND_COLOR = new Color(0x50d050);
    private static readonly ConsoleColor DEFAULT_PLAYER_BLACKGROUND_COLOR = new Color(0XCD853F);
    ...
    private static readonly char[][] SUIT_SYMBOLS =
        {{'♦','D'}, {'♠','S'}, {'♥','H'}, {'♣','C'} };
